...
public static class ConstraintManager
{
    ...
    private static readonly Dictionary<Type, Func<Solver, string, Constraint>> constraintTypeConstructors = new()
    {
        ...
        { typeof(MidnightCellsToggleConstraint), (solver, options) => new MidnightCellsToggleConstraint(solver, options) },
        ...
        { typeof(MidnightSumConstraint), (solver, options) => new MidnightSumConstraint(solver, options) },
    };
